...
export function getRiceScoreList(factor) {
  ...
  scorers.forEach((scorer, name) => {
    ...
    scoreList.push(new RiceBreed(name, score, factor.riceType, ricePriorities.get(name)))
  })
...
export class RiceBreed {
   ...
   * @param {String} type A type of the rice's breed
   */
  constructor(name, score, type, priority) {
    this.name = name
    this.score = score
    this.type = type
...
/** Priority to be used in sorting in case rices has equal score
 * @type {Map<String,Number>} 
 * */
const ricePriorities = new Map()
/**
 ...
 * @param {Number} priority Value to compare for sorting if score is equal
 * @see riceType in `expert_system/variable.js`
 */
function addRice(name, type, scorer, priority) {
  ...
  ricePriorities.set(name, priority)
...
addRice("กข 17", riceType.paddy, scorer()
  .add({ area: area.deepwater }, 1)
